...
export const getPublicWards = asyncHandler(async (req, res) => {
  console.log("🏛️ getPublicWards called - fetching wards from database...");
  ...
  try {
    ...
    console.log(`✅ Found ${wards.length} active wards in database`);
    ...
    console.error("❌ Error in getPublicWards:", error);
    res.status(500).json({
      success: false,
