 ...
 */
export function canViewComplaint(userRole, userId, complaint, userWardId) {
    // Admin can view all
 ...
 */
export function canModifyComplaint(userRole, userId, complaint, userWardId) {
 ...
 */
export function getAuthorizedNavigation(userRole) {
    const navItems = [];
    ...
    if (hasPermission(userRole, "ward:manage")) {
        navItems.push({ path: "/tasks", label: "My Tasks", roles: ["WARD_OFFICER"] }, { path: "/ward", label: "Ward Management", roles: ["WARD_OFFICER"] });
    }
    ...
    if (hasPermission(userRole, "system:admin")) {
        navItems.push({ path: "/admin/users", label: "Users", roles: ["ADMINISTRATOR"] }, {
            path: "/admin/config",
            label: "System Config",
            roles: ["ADMINISTRATOR"],
        }, {
...
export const DataFilters = {
     ...
     */
    filterComplaints: (complaints, userRole, userId, userWardId) => {
        return complaints.filter((complaint) => canViewComplaint(userRole, userId, complaint, userWardId));
    },
    /**
     * Filter users based on role permissions
     */
    filterUsers: (users, userRole, userId) => {
