export ;
  ...
  guestForm: {
    ...
    welcomeToSmartCity;
    complaintVerified;
    nowRegisteredCitizen;
    canTrackProgress;
    securityTip;
    setPasswordForEasierLogin;
    goToDashboard;
    submitAnotherComplaint;
    alreadyHaveAccount;
    loginHere;
    currentLocationIncluded;
    selectOnMap;
    imagePreview;
    previewOfUploadedImage;
    clickToUploadOrDrag;
    invalidEmailFormat;
    invalidPhoneFormat;
    descriptionTooShort;
...
export const englishTranslations = {
  ...
  guestForm: {
    ...
    step3: "After verification, you'll be registered citizen",
    ...
    nowRegisteredCitizen: "You are now registered citizen",
    canTrackProgress:
