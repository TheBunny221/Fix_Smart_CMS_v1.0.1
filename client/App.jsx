...
// Role-specific dashboards - loaded on demand
                ...
                <div className="min-h-screen bg-gray-50">
                  <Suspense fallback={<LoadingFallback />}>
                    <Routes>
                      ...
                      {/* Dashboard routes - Role-based unified routing */}
                      <Route
                        path="/dashboard"
                        element={
                          <UnifiedLayout>
