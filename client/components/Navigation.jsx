...
const Navigation = () => {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      roles: [UserRoles.CITIZEN, UserRoles.WARD_OFFICER, UserRoles.MAINTENANCE_TEAM, UserRoles.ADMINISTRATOR],
    },
    {
    ...
    },
    {
      ...
      roles: [UserRoles.WARD_OFFICER, UserRoles.MAINTENANCE_TEAM],
    },
    {
      label: translations?.nav?.ward || "Ward Management",
      path: "/ward",
      icon: <MapPin className="h-4 w-4" />,
      roles: [UserRoles.WARD_OFFICER],
    },
    {
      label: translations?.nav?.maintenance || "Maintenance",
      path: "/maintenance",
      icon: <Wrench className="h-4 w-4" />,
      roles: [UserRoles.MAINTENANCE_TEAM],
    },
    {
    ...
    },
    {
      ...
      roles: [UserRoles.WARD_OFFICER, UserRoles.ADMINISTRATOR, UserRoles.MAINTENANCE_TEAM],
    },
    {
  ...
  const filteredNavItems = navigationItems.filter((item) => {
    ...
    if (user.role === UserRoles.MAINTENANCE_TEAM) {
  ...
  const getRoleColor = (role) => {
    switch (role) {
      ...
      case UserRoles.WARD_OFFICER:
        return "bg-blue-100 text-blue-800";
      case UserRoles.MAINTENANCE_TEAM:
        return "bg-green-100 text-green-800";
      case UserRoles.CITIZEN:
